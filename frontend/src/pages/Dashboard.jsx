  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Fetch parts
        const partsResponse = await axios.get('http://localhost:3000/api/parts');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-purple-50 to-pink-50 p-6 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Link to="/admin/parts" className="bg-white rounded-xl shadow-md p-6 border border-purple-100 hover:border-blue-300 hover:shadow-lg transition-all group">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-gradient-to-r from-blue-400 to-purple-400 rounded-xl group-hover:scale-110 transition-transform">
              <FaPlus className="text-2xl text-white" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-blue-700 mb-1 group-hover:text-blue-600">Add New Part</h3>
              <p className="text-sm text-blue-600 group-hover:text-blue-500">Add a new spare part to your inventory</p>
            </div>
          </div>
        </Link>

        <Link to="/admin/orders" className="bg-white rounded-xl shadow-md p-6 border border-purple-100 hover:border-green-300 hover:shadow-lg transition-all group">
          <div className="flex items-center gap-4">
        ...
        <Link to="/admin/parts" className="bg-white rounded-xl shadow-md p-6 border border-purple-100 hover:border-orange-300 hover:shadow-lg transition-all group">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-gradient-to-r from-orange-400 to-amber-400 rounded-xl group-hover:scale-110 transition-transform">
              <FaBox className="text-2xl text-white" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-orange-700 mb-1 group-hover:text-orange-600">Manage Parts</h3>
              <p className="text-sm text-orange-600 group-hover:text-orange-500">View and manage your spare parts inventory</p>
            </div>
          </div>
        </Link>

        <Link to="/admin/analytics" className="bg-white rounded-xl shadow-md p-6 border border-purple-100 hover:border-pink-300 hover:shadow-lg transition-all group">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-gradient-to-r from-pink-400 to-rose-400 rounded-xl group-hover:scale-110 transition-transform">
              <FaChartBar className="text-2xl text-white" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-pink-700 mb-1 group-hover:text-pink-600">Analytics</h3>
              <p className="text-sm text-pink-600 group-hover:text-pink-500">View sales and performance analytics</p>
            </div>
          </div>
        </Link>
      </div>
