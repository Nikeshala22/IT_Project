              ...
              >
                ...
                <div className="relative z-10 max-w-[750px] text-white flex flex-col text-start p-8">
                  ...
                  <h1 className="text-6xl font-bold mt-4">
                    {slide.subtitle} <span className="text-[#0BEEFD]">Amazing</span>
                  </h1>
                  <p className="mt-4 text-lg md:text-xl">{slide.description}</p>
                  <Link to="/appointment-form">
                    <button
                      className={`px-4 py-3 text-xl text-[#006AFF] border-2 font-bold border-[#006AFF] rounded-md shadow-md transition-all duration-300 ease-in-out mt-4 w-[30%] ${
                        isLoggedin
                          ? 'bg-transparent hover:bg-[#006AFF] hover:text-white hover:shadow-lg hover:scale-105'
          ...
          <div className="w-full md:w-[48%] mb-6 md:mb-0 rounded-lg overflow-hidden flex-grow">
            <div className="grid h-full grid-cols-1 gap-4 p-4 md:grid-cols-2">
              {[
                ...
                <div
                  key={index}
                  className="p-4 transition-transform duration-300 ease-in-out border rounded-lg shadow-lg bg-gradient-to-r from-[#fefbfb] via-[#f5f5f5] to-[#e1e1e1] hover:scale-95"
                >
